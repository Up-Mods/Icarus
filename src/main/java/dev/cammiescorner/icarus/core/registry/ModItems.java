...
public class ModItems {
	...
	public static void register() {
		FabricItemGroupBuilder.create(new Identifier(Icarus.MOD_ID, "general")).icon(() -> new ItemStack(ModItems.WHITE_FEATHERED_WINGS)).appendItems(entries -> {
			entries.add(WHITE_FEATHERED_WINGS.getDefaultStack());
			entries.add(ORANGE_FEATHERED_WINGS.getDefaultStack());
			entries.add(MAGENTA_FEATHERED_WINGS.getDefaultStack());
			entries.add(LIGHT_BLUE_FEATHERED_WINGS.getDefaultStack());
			entries.add(YELLOW_FEATHERED_WINGS.getDefaultStack());
			entries.add(LIME_FEATHERED_WINGS.getDefaultStack());
			entries.add(PINK_FEATHERED_WINGS.getDefaultStack());
			entries.add(GREY_FEATHERED_WINGS.getDefaultStack());
			entries.add(LIGHT_GREY_FEATHERED_WINGS.getDefaultStack());
			entries.add(CYAN_FEATHERED_WINGS.getDefaultStack());
			entries.add(PURPLE_FEATHERED_WINGS.getDefaultStack());
			entries.add(BLUE_FEATHERED_WINGS.getDefaultStack());
			entries.add(BROWN_FEATHERED_WINGS.getDefaultStack());
			entries.add(GREEN_FEATHERED_WINGS.getDefaultStack());
			entries.add(RED_FEATHERED_WINGS.getDefaultStack());
			entries.add(BLACK_FEATHERED_WINGS.getDefaultStack());

			entries.add(WHITE_DRAGON_WINGS.getDefaultStack());
			entries.add(ORANGE_DRAGON_WINGS.getDefaultStack());
			entries.add(MAGENTA_DRAGON_WINGS.getDefaultStack());
			entries.add(LIGHT_BLUE_DRAGON_WINGS.getDefaultStack());
			entries.add(YELLOW_DRAGON_WINGS.getDefaultStack());
			entries.add(LIME_DRAGON_WINGS.getDefaultStack());
			entries.add(PINK_DRAGON_WINGS.getDefaultStack());
			entries.add(GREY_DRAGON_WINGS.getDefaultStack());
			entries.add(LIGHT_GREY_DRAGON_WINGS.getDefaultStack());
			entries.add(CYAN_DRAGON_WINGS.getDefaultStack());
			entries.add(PURPLE_DRAGON_WINGS.getDefaultStack());
			entries.add(BLUE_DRAGON_WINGS.getDefaultStack());
			entries.add(BROWN_DRAGON_WINGS.getDefaultStack());
			entries.add(GREEN_DRAGON_WINGS.getDefaultStack());
			entries.add(RED_DRAGON_WINGS.getDefaultStack());
			entries.add(BLACK_DRAGON_WINGS.getDefaultStack());

			entries.add(WHITE_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(ORANGE_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(MAGENTA_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(LIGHT_BLUE_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(YELLOW_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(LIME_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(PINK_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(GREY_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(LIGHT_GREY_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(CYAN_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(PURPLE_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(BLUE_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(BROWN_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(GREEN_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(RED_MECHANICAL_FEATHERED_WINGS.getDefaultStack());
			entries.add(BLACK_MECHANICAL_FEATHERED_WINGS.getDefaultStack());

			entries.add(WHITE_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(ORANGE_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(MAGENTA_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(LIGHT_BLUE_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(YELLOW_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(LIME_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(PINK_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(GREY_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(LIGHT_GREY_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(CYAN_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(PURPLE_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(BLUE_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(BROWN_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(GREEN_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(RED_MECHANICAL_LEATHER_WINGS.getDefaultStack());
			entries.add(BLACK_MECHANICAL_LEATHER_WINGS.getDefaultStack());

			entries.add(WHITE_LIGHT_WINGS.getDefaultStack());
			entries.add(ORANGE_LIGHT_WINGS.getDefaultStack());
			entries.add(MAGENTA_LIGHT_WINGS.getDefaultStack());
			entries.add(LIGHT_BLUE_LIGHT_WINGS.getDefaultStack());
			entries.add(YELLOW_LIGHT_WINGS.getDefaultStack());
			entries.add(LIME_LIGHT_WINGS.getDefaultStack());
			entries.add(PINK_LIGHT_WINGS.getDefaultStack());
			entries.add(GREY_LIGHT_WINGS.getDefaultStack());
			entries.add(LIGHT_GREY_LIGHT_WINGS.getDefaultStack());
			entries.add(CYAN_LIGHT_WINGS.getDefaultStack());
			entries.add(PURPLE_LIGHT_WINGS.getDefaultStack());
			entries.add(BLUE_LIGHT_WINGS.getDefaultStack());
			entries.add(BROWN_LIGHT_WINGS.getDefaultStack());
			entries.add(GREEN_LIGHT_WINGS.getDefaultStack());
			entries.add(RED_LIGHT_WINGS.getDefaultStack());
			entries.add(BLACK_LIGHT_WINGS.getDefaultStack());

			entries.add(FLANDRES_WINGS.getDefaultStack());
			entries.add(DISCORDS_WINGS.getDefaultStack());
			entries.add(ZANZAS_WINGS.getDefaultStack());
		}).build();
